...
def Devinette(nbre : int, Nom1 : str, Nom2 :str, Tableau : list[Joueur] )-> str:
    ...
    while essai != nbre or (essai == nbre and resultat== "Erreur") :
        ...
        if resultat == "Erreur" :                   # On a Erreur si le joueur a menti ou s'est trompé 
            ...
            if resultat == "\nJoueur 2, c'est gagné !!" :
                ...
                score2 = score2 -2                  #Joueur 2: On enlève deux point à chaque essai raté
        if retirer > 10 :
            print(Separation(2))
    ...
    print(Nom1,": ", score1)
    print(Nom2,": ", score2)
    ScoreDev(Tableau, Nom1,Nom2,score1,score2)
...
def DebutDevi(Nom1 : str, Nom2 : str, Tableau : list[Joueur]) :
    ...
    fin = Devinette(nbre, Nom1, Nom2, Tableau)
    print(fin)
    print(Separation(2))
